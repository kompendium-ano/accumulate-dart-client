...
Future<void> main() async {
  ...
  final String newKeyBookUrl =
      "acc://custom-adi-name-1707515657224.acme/book2"; // Assuming this is the correct variable name
  ...
  await createKeyBook(
      client, principalUrl, createKeyBookParam, existingAdiSigner);
}
...
Future<void> createKeyBook(
    ...
    Ed25519KeypairSigner existingAdiSigner) async {
